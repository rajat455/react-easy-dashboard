import { Box, AppBar, IconButton, Typography, useMediaQuery, useScrollTrigger, List, Divider, Stack, Badge } from "@mui/material";
...
export default function Header({ themeOptions }: Props) {
    ...
    const renderNavItem = themeOptions?.renderNavItem || null
    ...
    return <>
        ...
        <AppBar
            ...
            {(settings.themeLayout === "horizontal" &&  renderNavItem !== null) && <Box sx={{ paddingLeft: "12px !important", paddingRight: "12px !important" }}>
